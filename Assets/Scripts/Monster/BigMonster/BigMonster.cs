...
public class BigMonster : MonoBehaviour
{
    ...
    [SerializeField] protected Vector3 previusPosition;
    ...
    protected DropItemManager dropItemManager;

    [SerializeField] protected GameObject drop;

    [SerializeField] protected int dotDamage;

    [SerializeField] protected bool rainSlow;
    [SerializeField] protected bool rainDamage;
    [SerializeField] protected bool trickDamage;
    ...
    protected virtual IEnumerator FlameDot()
    {
        while (true)
        {
    ...
    protected virtual IEnumerator LastPosition()
    {
        while (true)
        {
    ...
    protected virtual IEnumerator MomentSlow(float slow)
    {
        speed *= slow;
    ...
    protected virtual IEnumerator ContinueSlow()
    {
        while (true)
        {
    ...
    protected virtual IEnumerator ContinueDamageCard(int damage)
    {
        while (true)
        {
            while (GameManager.instance.state)
